...
const CharPredictionResultsDisplay = ({
    taskStatus,
    predictions,
    displayText
}) => {
    ...
    return (
        <div className='row'>
            <div className="col-md-7">
                ...
                <small className="text-muted fst-italic text-center d-block mb-2">Click a character in brackets for more information.</small>
...
export default CharPredictionResultsDisplay;